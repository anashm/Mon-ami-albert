...
const Chapter = ({match}) => {
    ...
    useEffect(() => {
        ...
        const chapter_features_container = document.querySelector('.chapter-features-container');
    ...
    return (
        ...
        <section className = 'container chapter-page-container'>
            ...
            <div className="chapter-features-container">
                <ChapterButton name = 'Course' tab = {active} imgSrc = { courseImg }  clicked = { handleChapterCoursesButton } />
                <ChapterButton name = 'Quizz'  tab = {active}  imgSrc ={quizzImg} clicked = { handleChapterQuizzButton } />
                <ChapterButton name = 'Exercise'  tab = {active}  imgSrc = {exercisesImg} clicked = {handleChapterExercisesButton} />
            </div>
