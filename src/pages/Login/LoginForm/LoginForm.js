...
const LoginForm = (props) => {
  ...
  const btn =
    email !== "" && password !== "" ? (
      ...
      <Button disabled className="submit-btn w-100">
        Se connecter
      </Button>
    );
  return (
    <div className="form-container">
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <p className="subscribe-text text-center">
          ...
          <small className="login-link subscribe-link">
            {" "}
            <Link to="/eleve-create-account"> Inscris-toi </Link>{" "}
          </small>{" "}
        </p>
      </Form>
    </div>
