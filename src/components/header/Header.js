...
const ShareModal = (props) => (
  ...
  >
    <Modal.Header closeButton>
      <Modal.Title>Partager sur :</Modal.Title>
    </Modal.Header>
    ...
    <header className={`container-fluid header`}>
      <div className="container">
            ...
            {!logout && (
              <Fragment>
                      ...
                      <div className="div_logout_container">
                        ...
                        >
                          <Dropdown.Menu>
                            <Dropdown.Header>
                              {" "}
                              <span className="dropdown-header-titles">
                                {" "}
                                Profil{" "}
                              </span>
                            </Dropdown.Header>
                            ...
                            <Dropdown.Item>
                              <Link to="/profil">
                                ...
                                <span className="mon-profil-item-class">
                                  Mon Profil
                                </span>
                              </Link>
                            </Dropdown.Item>
                ...
                {userContext.current_location !== "/" &&
                  userContext.current_location !== "/dashboard-user" && (
                    <Fragment>
                      <Link
        ...
        <div className="mobile-header d-none">
          ...
          <div
            className="header-col ranking-col"
            role="button"
            onClick={() => setRankingModalShow(true)}
          >
            <p> Classement </p>
            <img src={league} alt="" />
          </div>
        ...
        <RankingModal
          show={rankingModalShow}
          onHide={() => setRankingModalShow(false)}
        />
        <ShareModal
          show={shareModalShow}
