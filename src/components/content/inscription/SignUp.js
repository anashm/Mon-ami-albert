...
const SignUp = (props) => {
  ...
  const btn =
    ...
    SignUpData.email !== "" &&
    SignUpData.re_password === SignUpData.password ? (
      <div className="row">
        <div className="col">
          <Button
  ...
  const errorMsg =
    error !== "" ? (
      <span style={{ color: "red", fontWeight: "400" }}>{error.message}</span>
    ) : null;
      ...
      <div className="row" style={{ marginTop: "-2%" }}>
        ...
        <div className="col-md-4" style={{ marginLeft: "4%" }}>
          <div style={{ float: "left", width: "20%" }}>
            ...
            {props.location.state.avatar ? (
              <img
                src={require(`../../../images/avatars/${props.location.state.avatar}.png`)}
                style={{ width: "80%" }}
              />
            ) : (
              <img src={avatar} style={{ width: "70%" }} />
          ...
          <p className="text-avatar">
            {" "}
            <b> {props.location.state.fonction}</b>.&nbsp;&nbsp;
