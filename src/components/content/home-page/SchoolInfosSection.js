...
const SchoolInfosSection = () => {
  ...
  return (
    <section
      className="container-fluid school-infos-Section"
      data-aos="fade-up"
      data-aos-once="false"
    >
      <div className="container">
        <div className="row">
          <div className="description-container">
            ...
            >
              <span>
                Le contenu proposé par Mon ami Albert est conçu pour permettre à
                l’étudiant d’apprendre tout en étant stimulé. Pour cela, nous
                avons développés une approche positive au cœur de notre
                plateforme.{" "}
              </span>
              <span>
                Un suivi pour le lycée et les classes préparatoire, des
                exercices corrigés, des jeux/Quizz et un classement pour te
                challenger ! Ça plait aux étudiants, ça les motives et ça les
                rend autonomes.
              </span>
            </HorizontalCard>
          </div>
