  ...
  >
    ...
    <Modal.Body>
      <iframe
        ...
        height="500"
        title="MAA"
        src="https://www.youtube.com/embed/UwoQinuH7p0"
        frameborder="0"
...
const PopUp = ({ closeToast }) => (
  <div style={{ width: "200%" }} className="petite_div">
    ...
    <div className="btn_stores" style={{ marginTop: "10px" }}>
      ...
      <div>
        <div className="box_stores">
          {" "}
          <img src={btn_playstore} alt="" style={{ width: "100%" }} />{" "}
        </div>
        <div className="box_stores">
          {" "}
          <img src={btn_appstore} alt="" style={{ width: "100%" }} />{" "}
        </div>
      </div>
    </div>
  </div>
...
const HeroSection = memo(({ userConnected }) => {
  ...
  const text_slider = [
    ...
    },
    {
      ...
      text:
        "Des évaluations fréquentes, pour valider les acquis à la fin de chaque chapitre.",
    },
    {
    ...
    },
    {
      ...
      text:
        "Nos étudiants gagnent jusqu’à 4.2 points sur leur moyenne générale.",
    },
  ];
  ...
  const heroSectionInfos = {
    ...
    text:
      "Mon Ami Albert est une application et un site web de soutien scolaire, qui accompagne les élèves du lycée et des classes préparatoires pour combler leurs lacunes et à prendre de l’avance de manière continue. Des cours, des quizz, des exercices corrigés, des annales ou des exemples de contrôles sont au rendez-vous pour un accompagnement pointu.",
  };
  ...
  return (
    <section className="container-fluid hero-section">
        ...
        <div className="row">
          <div className="hero-section-content-container">
            ...
            <div className="hero-section-description-container">
              ...
              >
                {" "}
                Le soutien scolaire de <br /> La nouvelle génération{" "}
              </h2>
              <p
                className="hero-section-paragraphe"
                data-aos="fade-up"
                data-aos-once="true"
                data-aos-delay="200"
              >
                {" "}
                {heroSectionInfos.text}{" "}
              </p>
              <div className="hero-section-buttons-container fade-bottom">
                {!userConnected ? (
                  <Fragment>
                    <Link
                      className="hero-section-button register-button"
                      to="/eleve-create-account"
                    >
                      {" "}
                      s'inscrire gratuitement{" "}
                    </Link>
                    <Link
                      className="hero-section-button login-button"
                      to="/login"
                    >
                      {" "}
                      Se connecter{" "}
                  ...
                  <Fragment>
                    <Link
                      className="hero-section-button dashboard-button"
                      to="/dashboard-user"
                    >
                      {" "}
                      Mon Parcours{" "}
      ...
      <HomepageModal show={showModal} onHide={() => setShowModal(false)} />
    </section>
  );
});
